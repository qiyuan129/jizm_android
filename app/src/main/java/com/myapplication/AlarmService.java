...
public class AlarmService extends Service {
    ...
    public void onCreate(){
        ...
        intent.setClass(this, DoPeriodicService.class);
        ...
        PendingIntent pi= PendingIntent.getService(this, 1210, intent, PendingIntent.FLAG_CANCEL_CURRENT);//如果存在，先取消再重新获取
        ...
        aManager.setRepeating(AlarmManager.RTC_WAKEUP,System.currentTimeMillis()+1000,1*60*1000,pi);
